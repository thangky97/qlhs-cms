    ...
    <div className="invoice-list-table-header w-100 mr-1 ml-50 ">
      {
        <Row className="justify-content-end">
          ...
          >
            <Button.Ripple
              color="primary"
              onClick={() => history.push("/apps/cms/cloud/cloud/edit")}
            >
...
const CloudList = () => {
  ...
  useEffect(() => {
    (async () => {
      ...
      if (listAbout?.data?.data?.length > 0) {
        setCloudData(listAbout?.data?.data[0]);
      }
    })();
  }, []);
  const toggleSidebar = () => {
  ...
  return (
    <div className="app-user-list">
      ...
      <ExtensionsHeader title={<FormattedMessage id="Cloud" />} />
      <Row>
        <Col md={12}>

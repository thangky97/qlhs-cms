...
import { updateClassroom } from "../store/action";
import { useHistory } from "react-router-dom";

const EditClassroom = ({ selected, intl }) => {
  ...
  return (
    <Card className="invoice-preview-card mb-0 p-3">
      <ExtensionsHeader title={<FormattedMessage id="Chỉnh sửa phòng học" />} />
...
export default injectIntl(EditClassroom);

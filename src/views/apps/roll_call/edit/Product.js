...
import { update, getInstractors, getDataDepartment } from "../store/action";
...
const ProductTab = ({ selected, intl }) => {
  ...
  const departmentOption = {
    value: productData?.department?.id,
    label: `${productData?.department?.code} -  ${productData?.department?.name}`,
  };

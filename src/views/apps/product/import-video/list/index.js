          ...
          >
            <div className="justify-content-end">
              <Button.Ripple color="primary" onClick={toggleSidebar}>
                <FormattedMessage id="Add New Video" />
              </Button.Ripple>
            </div>
          </Col>
        </Row>
...
const VersionList = ({ intl }) => {
  ...
  const columns = [
    ...
    {
      name: <FormattedMessage id="VideoName" />,
      minWidth: "120px",
    ...
    {
      name: <FormattedMessage id="TypeVideo" />,
      minWidth: "120px",
      ...
      cell: (row) => (
        <UncontrolledDropdown>
          ...
          <DropdownMenu right>
            <DropdownItem
              tag={Link}
              to={`/apps/product/import-video/edit/${row.id}`}
              className="w-100"
            >
  ...
  return (
    <div className="app-user-list">
      <ExtensionsHeader title={<FormattedMessage id="Video Management" />} />
      <Card>
        <DataTable
          noHeader
          subHeader

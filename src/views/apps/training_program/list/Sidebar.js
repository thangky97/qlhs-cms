...
import { addTrainingProgram } from "../store/action";

const SidebarNewTrainingProgram = ({
  intl,
  open,
  toggleSidebar,
  disable,
  ...
  return (
    <Sidebar
      size="lg"
      open={open}
      title={<FormattedMessage id="Thêm mới chương trình học" />}
...
export default injectIntl(SidebarNewTrainingProgram);
